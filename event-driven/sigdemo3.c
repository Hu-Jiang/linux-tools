/* sigdemo3.c
 * purpose: show answer to signal questions
 * question1: does the handler stay in effect after a signal arrives?
 * question2: what if a signalX arives while handling signalX?
 * question3: what if a signalX arives while handling signalY?
