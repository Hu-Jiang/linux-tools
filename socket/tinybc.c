 ...
 *         * demonstrates bidrectional pipes
 *         * input looks like number op number which tinybc
 ...
 *              c. in the dc-to-bc process, connect stdin and out to pipes then execl dc 
 *              d. in the tinybc-process, no plumbing to do just talk to human via normal i/o and send stuff via pipe
