 ...
 * int make_server_socket(protnum) returns a server socket
 *                                 or -1 if error
 * int make_server_socket_q(portnum, backlog)
 * int connect_to_server(char* hostname, int portnum) returns a connected socket
 *                                                    or -1 if error
 */
...
int connect_to_server(char* host, int portnum) {
    ...
    bzero(&servaddr, sizeof(servaddr)); // zero the address
