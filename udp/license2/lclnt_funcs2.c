/* lclnt_funcs2.c: functions for the client of the license server version 2
 */
 ...
 * notes: assume server is on same host as client
 */
int setup() {
...
/*
 * get_ticket get a ticket from the license server
...
/*
 * do_transaction send a request to the server and get a response back
 ...
 * notes: for extra security, compare retaddr to serv_addr(why?)
 */
 ...
 * ret nothing, dies on error
 */
int narrate(char* msg1, char* msg2) {
    fprintf(stderr, "CLIENT [%d]: %s %s\n", pid, msg1, msg2);
}

int syserr(char* msg1) {
    char buf[MSGLEN];
